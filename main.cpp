...
int main(int argc, char **argv)
{
	...
	cout << "Test 4: Write a function that takes a 32-bit unsigned integer "
		 << endl
		 << "number and returns the maximum and minimum 32-bit "
		 << endl
		 << "unsigned integer numbers which can be obtained using "
		 << endl
		 << "the same number of bits set to 1 as in the taken number"
		 << endl;
	int32_t a = 255 - 1 + 256;
	MinMaxPair p1(a);
	...
	TreeNode n5(5, &n7, &n10), n4(4, &n6, nullptr), n3(3, nullptr, nullptr);
